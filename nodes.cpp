...
/*double Nodes::getTotalLat() const{
  double totalLat = 0;
  double numNodes = 0;
  for(auto n : this->MapNodes){
    totalLat += n.second.getLat();
    numNodes++;
  }
  return totalLat/numNodes;
}

double Nodes::getTotalLon() const{
  double totalLon = 0;
  double numNodes = 0;
  for(auto n : this->MapNodes){
    totalLon += n.second.getLon();
    numNodes++;
  }
  return totalLon/numNodes;
}*/